...
<div class="w-full md:max-w-lg md:mx-auto">
    <div class="flex flex-col items-center justify-center p-6 space-y-8 text-center bg-white shadow">
        ...
        <div class="flex items-center justify-center space-x-3">
            <a href="https://github.com/alexjustesen" ref="noopener" target="_blank" class="flex items-center px-3 py-2 text-gray-700 transition duration-300 ease-in-out bg-white border border-gray-600 hover:bg-gray-700 hover:border-gray-800 hover:text-white focus:outline-none focus:shadow-outline-gray lg:text-lg">
            ...
            <a href="https://twitter.com/alexjustesen" ref="noopener" target="_blank" class="flex items-center px-3 py-2 text-gray-700 transition duration-300 ease-in-out bg-white border border-gray-600 hover:bg-blue-500 hover:border-blue-600 hover:text-white focus:outline-none focus:shadow-outline-blue lg:text-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
